<template>
   <div>
      <el-button type="primary" plain size="medium" @click="showAddForm">添加分类</el-button>
      <u-form ref="form"/>
...
export default {
   ...
   methods:{
      ...
      showEditForm(data){
         ...
         this.$refs.form.title = '修改分类'
         // console.log(this.$refs.form);
         this.$refs.form.setEditForm(data)
      }
   }
}
</script>
